...
export const COLORS = {
  // ---------- الخلفيات والسطوح ----------
  appBg: "#FFFFFF",        // الخلفية الأساسية للتطبيق (مستخدمة كـ fallback فقط الآن)
  surface: "rgba(255,255,255,0.65)",      // الكروت والبانلز — زجاجي (Glassmorphism)، يتطابق مع backdrop-filter أدناه
  surfaceAlt: "rgba(255,255,255,0.35)",   // السطح الغاطس — زجاجي أخف
